class Chinpokomon:
    ...
    def attack(self, opponent_chinpokomon):
        ...
        if self.chinpokomon_type == "grass" and opponent_chinpokomon.type == "water":
            damage = damage * 2
        elif self.chinpokomon_type == "fire" and opponent_chinpokomon.type == "grass":
            damage = damage * 2
        elif self.chinpokomon_type == "water" and opponent_chinpokomon.type == "fire":
            damage = damage * 2
        opponent_chinpokomon.lose_health(damage)
        print("{opponent} was attacked and lost {damage} health points!".format(opponent=opponent_chinpokomon,
                                                                                damage=damage))
...
class Trainer:
    ...
    def use_potion(self, active_chinpokomon):
        self.active_chinpokomon = active_chinpokomon
        if self.n_of_potions < 0:
            print("There are no potions left to use!")
        else:
            active_chinpokomon.gain_health(10)
            print("{active_chinpokomon} was healed using a potion!".format(active_chinpokomon=self.active_chinpokomon))
